...
public class AppDbContext
{
    ...
    public AppDbContext(IOptions<DatabaseSettings> databaseSettings)
    {
        ...
        _connectionString =
            $"Server={databaseSettingsValue.Host};Port={databaseSettingsValue.Port};Database={databaseSettingsValue.Name};Uid={databaseSettingsValue.Username};Pwd={databaseSettingsValue.Password};";
    }
